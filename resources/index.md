  ...
  <div class="resource-grid">
    <article class="page-card resource-card">
      ...
      <div class="page-pill-list">
        ...
        <span class="page-pill resource-pill resource-pill-strong">~8.4 TB RAM</span>
    ...
    <article class="page-card resource-card">
      ...
      <div class="page-pill-list">
        ...
        <span class="page-pill resource-pill resource-pill-strong">~3.8 TB RAM</span>
