...
<section class="page-hero">
  <p class="page-kicker">Training and Mentoring</p>
  <h1>Education</h1>
  <p class="page-lead">
...
<section class="page-section">
  <div class="education-overview-grid">
    <article class="page-card education-overview-card">
      <span class="education-overview-label">Project-based learning</span>
      <strong>Student-led research tracks</strong>
      <!-- <p>Hands-on programs that let trainees explore computational oncology questions in a guided but independent format.</p> -->
    </article>
    <article class="page-card education-overview-card">
      <span class="education-overview-label">Mentored outcomes</span>
      <strong>Awards and presentations</strong>
      <!-- <p>Structured support for student projects that grow into academic festival presentations, reports, and recognitions.</p> -->
    </article>
    <article class="page-card education-overview-card">
      <span class="education-overview-label">Courses</span>
      <strong>Formal teaching and seminars</strong>
      <!-- <p>Lecture-based learning that introduces biomedical AI, data science, and research thinking to diverse student audiences.</p> -->
    </article>
    <article class="page-card education-overview-card">
      <span class="education-overview-label">Exposure</span>
      <strong>Global academic visits</strong>
      <!-- <p>Visits and exchanges that connect trainees with broader research environments and collaborative academic culture.</p> -->
    </article>
  </div>
</section>
...
<section class="page-section">
  <div class="page-section-head">
    ...
    <h2>Student research and mentoring programs</h2>
...
<section class="page-section">
  <div class="page-section-head">
    ...
    <h2>Student outcomes and awards</h2>
...
<section class="page-section">
  <div class="page-section-head">
    ...
    <h2>Courses and classroom engagement</h2>
...
<section class="page-section">
  <div class="page-section-head">
    <p class="page-kicker">Academic Visits</p>
    <h2>Exposure beyond the lab</h2>
...
<section class="page-section">
  <div class="page-cta">
    <div class="page-cta-copy">
      <p class="page-kicker">Growing archive</p>
      <h2>The education archive will continue to expand</h2>
      <p>This page is set up to grow with additional student projects, course snapshots, program photos, and mentoring outcomes as the lab's educational activities continue.</p>
    </div>
    <a class="button" href="{{ '/contact' | relative_url }}">Ask about education</a>
  </div>
</section>
